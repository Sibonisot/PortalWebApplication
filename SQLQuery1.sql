USE [DataPortal]
GO
/****** Object:  Table [dbo].[PortalRole]    Script Date: 2021/07/29 13:04:02 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[PortalUser]    Script Date: 2021/07/29 13:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[PortalUserRole]    Script Date: 2021/07/29 13:04:30 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[PortalUserRole](
	...
	[IsActive] [bit] NOT NULL,
	[DateCreated] [datetime] NOT NULL,
 CONSTRAINT [PK_PortalUserRole_PortalUserID] PRIMARY KEY CLUSTERED 
(
	[PortalUserId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
